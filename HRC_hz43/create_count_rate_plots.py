...
#
            for sign in ['n_', 'p_']:
                for step in range(0, 20):
                    ...
                    outname = web_dir  + 'Plots/Count_rates/' + col + sign + inst 
                    outname = outname  + '_' + str(step) + '.png'
#
#--- read data
#
                    try:
...
#--- main plot
#
                        plot_panel(xmin, xmax, ymin, ymax, time_list, cnt_list, 
                                   err_list,  bkg_list, berr_list, xname, yname, yname)
...
#
            ...
            plot_panel(xmin, xmax, ymin, ymax, time_list, cnt_list, err_list, bkg_list, 
                       berr_list, xname, yname2, yname)
