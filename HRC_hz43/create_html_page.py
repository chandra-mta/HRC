...
#-----------------------------------------------------------------------------------------------
#-- create_html_page: create hz43.html page                                                  ---
#-----------------------------------------------------------------------------------------------

def create_html_page():
    """
    create hz43.html page
...
#--- read the template
#
    hfile = house_keeping + 'hz43_template'
...
def read_slope():
    ...
    output: save    --- a dictionary with index of <samp/pi>_<i/s>_<p/n> with 
                        a list of slope values the list can contain only 1 value 
                        or as many as 20 slope values.
            save2   --- a dictionary with index of <samp/pi>_<i/s>_<p/n> with 
                        a list of the secnd slope values
    """
    save  = {}
    save2 = {}
    for head in ['samp', 'pi']:
