...
#
    try:
        chk = create_image_file(hdir, year, oname, lev1, lev2, instmap, \
                                sbin, factor, lev1_opt, lev2_opt, sec)
...
#
        ...
        wline = "Something wrong or no data for Year: " + str(year) 
        wline = wline + ' of the instrument of: ' + str(hdir)
        print(wline)
...
#
            ...
            if hdir == 'hrc_s_125_hi':
                ...
                lev2_opt = '[events][chip_id=' + str(sec) 
                lev2_opt = lev2_opt + '][pha=0:254,status=xxxxxx00xxxx0xxx0000x000xx0000xx]'
    else:
        return NULL
...
def create_binned_image(image_in, image_out, xs='', xe='', xsize=256, ys='',\
                        ye='', ysize=256, opt1='', opt2=''):
    """
