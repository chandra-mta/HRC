...
import adjust_vega_position     as avp
...
def create_data_tables(table):
    ...
    for ent in data:
        ...
        fits = hcf.run_arc5gl(0, 0, obsid=str(obsid), level='1', filetype='evt1')
...
#
#--- find the "current" Vega position adjucted with the proper motion
#
    [ra, dec] = avp.adjust_vega_position(fyear)
#
...
#
    ...
    mcf.rm_files('center_area.fits')
    mcf.rm_files('bkg_area.fits')
#
...
#
    dtf   = hcf.run_arc5gl(0, 0, obsid=str(obsid), level='1', filetype='dtf')
